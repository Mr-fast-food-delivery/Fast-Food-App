...
# 🔹 INT-AUTH-01 – Register user thành công (Full flow)
...
# 🔹 INT-AUTH-04 – Transaction rollback khi 1 role không hợp lệ
def test_INT_AUTH_04_register_rollback_multiple_roles(base_url, register_payload):
    ...
    assert login_try.status_code == 404
